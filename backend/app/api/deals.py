...
async def get_deal(deal_id: UUID, provider: DataProvider = Depends(get_data_provider)) -> FlightDeal:
    try:
...
@router.get("/background-refresh", response_model=BackgroundRefreshResponse, summary="Background refresh task")
